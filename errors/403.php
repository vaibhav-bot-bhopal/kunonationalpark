<?php
define('BASE_URL', 'http://localhost/kunonationalpark.org/');
?>
...
<head>
    ...
    <title>Kuno National Park | Access Forbidden</title>
    <!-- Place favicon.ico in the root directory -->
    <link rel="shortcut icon" <?php echo 'href="' . BASE_URL . 'public/assets/images/favicon.ico"' ?> type="image/x-icon">
    <link rel="icon" <?php echo 'href="' . BASE_URL . 'public/assets/images/favicon.ico"' ?> type="image/x-icon">
