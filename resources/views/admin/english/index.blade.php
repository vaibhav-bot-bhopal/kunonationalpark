...
<div class="content-header">
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 offset-lg-2 offset-md-2">
            ...
            <form action="{{ url('admin/eng_news_create') }}" method="post" enctype="multipart/form-data">
                @csrf
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><a href="{{ url('admin/eng_news_edit') }}/{{$data->id}}" class="btn btn-sm btn-primary">Edit</a></td>
                    <td>
                        <button type="button" class="btn btn-sm btn-danger" onclick="deletePost({{ $data->id }})">Delete</button>
                        <form id="delete-form-{{ $data->id }}" action="{{ route('eng_news_del', $data->id) }}" method="POST" style="display: none;">
                            @csrf
                            @method('DELETE')
                        </form>
                    </td>
