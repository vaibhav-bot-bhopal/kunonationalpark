                    ...
                    <div class="col-lg-6 col-md-6 offset-lg-3 offset-md-3">
                        ...
                        <div class="card card-success card-outline">
                            <div class="card-body box-profile">
                                ...
                                <form action="{{ route('knp.admin.updatePassword') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control {{($errors->any() && $errors->first('password_confirmation')) ? 'is-invalid' : ''}}" id="password_confirmation" name="password_confirmation" placeholder="Enter Your Confirm Password">
                                        @if ($errors->any())
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if (Auth::user()->role_as == 'admin')
                                            <a href="{{route('knp.dashboard')}}" class="btn btn-danger"><i class="nav-icon fas fa-arrow-circle-left" style="margin-right: 5px;"></i>BACK</a>
                                        @endif
                                    </div>
                                </form>
                            ...
                            <div class="card-body box-profile">
                                ...
                                <form action="{{ route('knp.admin.updatePassword') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control {{($errors->any() && $errors->first('password_confirmation')) ? 'is-invalid' : ''}}" id="password_confirmation" name="password_confirmation" placeholder="अपना कन्फर्म पासवर्ड दर्ज करें">
                                        @if ($errors->any())
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{$errors->first('password_confirmation')}}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if (Auth::user()->role_as == 'admin')
                                            <a href="{{route('knp.dashboard')}}" class="btn btn-danger"><i class="nav-icon fas fa-arrow-circle-left" style="margin-right: 5px;"></i>वापस</a>
                                        @endif
                                    </div>
                                </form>
