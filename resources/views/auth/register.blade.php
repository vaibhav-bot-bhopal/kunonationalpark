...
@section('title', 'KNP - Registration System')
...
<div class="register-box">
    <div class="card card-outline card-primary">
        <div class="logo text-center mt-2">
            <img src="{{asset('public/assets/images/kuno_logo.png')}}" alt="Kuno-Logo" width="80" height="80">
        </div>

        <div class="card-header text-center">
            <a href="{{ url('/') }}" class="h1" target="_blank"><b>Kuno</b>NP</a>
        </div>
